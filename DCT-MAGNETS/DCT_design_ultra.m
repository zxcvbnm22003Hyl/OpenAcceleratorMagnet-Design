...
%
% == 核心功能 ==
% 本脚本是一个集大成者，它将先前多个脚本的功能融合到一个强大且灵活的
% 工具中。用户可以通过一个中心控制面板，生成多种不同几何形态的DCT线圈。
%
% == 集成特性 ==
% 1. 【几何可选】: 可生成【线性(直线)】或【弧形(弯曲)】两种磁铁骨架。
% 2. 【末端可选】: 可选择【跑道形】(半圆形末端)或经过优化的【圆角矩形】末端。
% 3. 【间距可选】: 可选用简单的【均匀】层间距，或基于导体物理尺寸的、更
%    高级的【防重叠】策略，从根本上杜绝导体干涉。
% 4. 【高性能】: 采用【矢量化】计算，尤其在处理弧形几何时，极大提升了
%    运算效率。
